...
ESP32-CW-Keyer is a simple implementation for building a USB CW Key adapter. 

This is a programmable alternative to the official VBand dongle, as well as Chinese copies that often need tweakings at boot to be able to use Vband mapping.

Fully compatible on computers, mobiles and tablets as it behave like a HID keyboard.
